...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-4G4NL83\\SQLEXPRESS;Database=ShoppingCartDb;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CtHoaDon>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CT_HOA_D__3214EC27823D31C6");
            ...
            entity.HasOne(d => d.HoaDon).WithMany(p => p.CtHoaDons)
                ...
                .HasConstraintName("FK__CT_HOA_DO__HoaDo__440B1D61");

            entity.HasOne(d => d.SanPham).WithMany(p => p.CtHoaDons)
                .HasForeignKey(d => d.SanPhamId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CT_HOA_DO__SanPh__44FF419A");
        });

        modelBuilder.Entity<HoaDon>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__HOA_DON__3214EC2703488D40");
            ...
            entity.HasOne(d => d.MaKhachHangNavigation).WithMany(p => p.HoaDons)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HOA_DON__MaKhach__412EB0B6");
        });

        modelBuilder.Entity<KhachHang>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__KHACH_HA__3214EC27E342F06D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LOAI_SAN__3214EC2755268EE4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QUAN_TRI__3214EC2769E99FFD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SAN_PHAM__3214EC27D83635DA");

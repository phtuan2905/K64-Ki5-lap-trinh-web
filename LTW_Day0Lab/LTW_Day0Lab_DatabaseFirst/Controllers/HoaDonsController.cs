...
using LTW_Day0Lab_DatabaseFirst.Models;

namespace LTW_Day0Lab_DatabaseFirst.Controllers
{
    public class HoaDonsController : Controller
    {
        private readonly ShoppingCartDbContext _context;

        public HoaDonsController(ShoppingCartDbContext context)
        {
            _context = context;
        }
        ...
        {
            var shoppingCartDbContext = _context.HoaDons.Include(h => h.MaKhachHangNavigation);
            return View(await shoppingCartDbContext.ToListAsync());
        }
        ...
        {
            ViewData["MaKhachHang"] = new SelectList(_context.KhachHangs, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MaHoaDon,MaKhachHang,NgayHoaDon,NgayNhan,HoTenKhachHang,Email,DienThoai,DiaChi,TongTriGia,TrangThai")] HoaDon hoaDon)
        {
            ...
            ViewData["MaKhachHang"] = new SelectList(_context.KhachHangs, "Id", "Id", hoaDon.MaKhachHang);
            return View(hoaDon);
        }

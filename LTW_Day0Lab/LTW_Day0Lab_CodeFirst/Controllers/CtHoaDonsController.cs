...
namespace LTW_Day0Lab_CodeFirst.Controllers
{
    public class CtHoaDonsController : Controller
    {
        private readonly ShoppingCartDbContext _context;

        public CtHoaDonsController(ShoppingCartDbContext context)
        {
            _context = context;
        }
        ...
        {
            var shoppingCartDbContext = _context.CtHoaDons.Include(c => c.HoaDon).Include(c => c.SanPham);
        ...
        public async Task<IActionResult> Create([Bind("Id,HoaDonId,SanPhamId,SoLuongMua,DonGiaMua,ThanhTien,TrangThai")] CtHoaDon ctHoaDon)
        {
            ...
            ViewData["SanPhamId"] = new SelectList(_context.SanPhams, "Id", "HinhAnh", ctHoaDon.SanPhamId);
            return View(ctHoaDon);
        }
